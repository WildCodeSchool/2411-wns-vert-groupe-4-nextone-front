    ...
    <div className="h-screen flex items-stretch justify-between bg-background px-12 py-10">
      <div className="w-[50%] flex items-center justify-center px-24">
        <Card className="flex flex-col align-center justify-center w-full shadow-none border-0 py-12 px-4">
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-[45px]">
              <div className="flex flex-col gap-[30px]">
                <InputWithLabel label="Adresse mail" type="email" placeholder="example@example.com" error={errors.email?.message} {...register("email")} className="!text-base font-normal !bg-transparent !shadow-none w-full"/>
                <InputWithLabel label="Mot de passe" type="password" placeholder="**********" error={errors.password?.message} {...register("password")} className="!text-base font-normal !bg-transparent !shadow-none"/>
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center gap-2.5">
                    <Checkbox id="stay-connected" checked={stayConnected}
              ...
              <Button type="submit" className="w-full bg-[#1f2511] py-7 rounded-lg font-['Archivo',Helvetica] font-light text-lg">
                Me connecter
              </Button>
            </form>
            ...
            <p className="text-center text-sm mt-[45px] font-['Archivo',Helvetica] font-normal text-[#1f2511]">
              ...
              <button type="button" className="hover:underline bg-transparent p-0 cursor-pointer">
                Contactez-nous
              </button>
            </p>
          </CardContent>
      ...
      <div className="w-[50%] flex items-center justify-center pl-24 overflow-hidden">
        <img src="/login-picture.jpg" alt="Accueil NextOne" className="w-[100%] h-full object-cover rounded-lg"/>
      </div>
    </div>
  );
}
